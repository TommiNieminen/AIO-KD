...
python -m fairseq_cli.train /scratch/project_2006944/tommi/aio_kd/AIO-KD/data-bin/iwslt14.tokenized.de-en \
  --task translation --arch transformer_shared_ffn_iwslt_de_en --share-all-embeddings \
  ...
  --adam-betas '(0.9,0.98)' --save-dir ./ckpts/iwslt14_de_en_shared_ffn/stage2 \
  --no-epoch-checkpoints --fp16 --dropout 0.3 \
  --finetune-from-model ./ckpts/iwslt14_de_en_shared_ffn/stage1/checkpoint_best.pt
